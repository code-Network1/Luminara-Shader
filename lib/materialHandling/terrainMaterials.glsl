                        ...
                        if (mat < 10016) {
                            if (mat < 10008) {
                                if (mat < 10004) { // No directional shading
                                    ...
                                    // Luminara Shader Enhanced Flowers: Balanced flower detection (NO GRASS)
                                    ...
                                    // More balanced grass exclusion - allow more flowers
                                    bool isAnyGrass = (color.g > 0.32 && color.g > color.r * 1.15 && color.g > color.b * 1.15);
                                    bool isSavannaGrassType = (color.r > 0.25 && color.g > 0.25 && color.b < 0.35 && abs(color.r - color.g) < 0.12 && max(color.r, color.g) < 0.6);
                                    bool isDriedGrassType = (color.r > color.b * 1.3 && color.g > color.b * 1.3 && color.b < 0.4 && max(color.r, color.g) < 0.65 && abs(color.r - color.g) < 0.1);
                                    bool isBrightColorfulFlower = (totalColor > 0.9 && colorVariance > 0.12); // More relaxed criteria
                                    
                                    if (isBrightColorfulFlower && !isAnyGrass && !isSavannaGrassType && !isDriedGrassType) {
                            ...
                            if (mat < 10024) {
                                if (mat < 10020) { // Non-waving Foliage
                                    ...
                                    // Luminara Shader Enhanced Flowers: Check if this is a colorful flower
                                    float totalColor = color.r + color.g + color.b;
                                    float colorVariance = max(max(abs(color.r - color.g), abs(color.g - color.b)), abs(color.b - color.r));
                                    
                                // More balanced grass detection for second check
                                bool isDefinitelyGrass = (color.g > 0.3 && color.g > color.r * 1.1 && color.g > color.b * 1.1 && totalColor < 1.8);
                                bool hasGrassLook = (color.r < 0.65 && color.b < 0.65 && color.g > 0.32);
                                bool isSavannaGrass2 = (color.r > 0.25 && color.g > 0.25 && color.b < 0.35 && abs(color.r - color.g) < 0.12 && max(color.r, color.g) < 0.6);
                                bool isDriedGrass2 = (color.r > color.b * 1.3 && color.g > color.b * 1.3 && color.b < 0.4 && abs(color.r - color.g) < 0.1);
                                
                                if (totalColor > 1.0 && colorVariance > 0.12 && !isDefinitelyGrass && !hasGrassLook && !isSavannaGrass2 && !isDriedGrass2) {
                        ...
                        if (mat < 10080) {
                            if (mat < 10072) {
                                ...
                                if (mat < 10076) { // Fire
                                    ...
                                    emission = 2.35;
                                    #ifdef NETHER
                                        emission *= 0.4; // Luminara Shader: Reduce fire emission in Nether
                                    #endif
                                    ...
                                    emission = 1.5;
                                    #ifdef NETHER
                                        emission *= 0.4; // Luminara Shader: Reduce soul fire emission in Nether
                                    #endif
                        ...
                        if (mat < 10400) {
                            ...
                            if (mat < 10408) {
                                ...
                                if (mat < 10412) { // Basalt+
                                    ...
                                    #ifdef NETHER
                                        emission *= 0.3; // Luminara Shader: Significantly reduce glowstone emission in Nether
                                    #endif
                            ...
                            if (mat < 10504) {
                                if (mat < 10500) { // Torch
                                    ...
                                    if (color.r > 0.95) {
                                        ...
                                        #endif
                                        #ifdef NETHER
                                            emission *= 0.4; // Luminara Shader: Reduce torch emission in Nether
                                        #endif
                                        color.r *= 1.4;
                                        color.b *= 0.5;
                                    } 
                                    ...
                                    if (dotColor > 2.0) {
                                        emission = 3.3;
                                        #ifdef END
                                            // Luminara Shader: Enhanced End Rod with magical pulsing
                        ...
                        if (mat < 10560) {
                            ...
                            if (mat < 10568) {
                                if (mat < 10564) { // Lantern
                                    ...
                                    #ifdef NETHER
                                        emission *= 0.4; // Luminara Shader: Reduce lantern emission in Nether
                                    #endif
...
// Luminara Shader: Global emission reduction system for Nether
#ifdef NETHER
    if (emission > 0.1) {
